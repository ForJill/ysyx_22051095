...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0000001 ????? ????? 100 ????? 01100 11", div    , R, R(dest) = src2 == 0 ? 0 : src1 / src2);
  INSTPAT("0000001 ????? ????? 100 ????? 01110 11", divw   , R, R(dest) = SEXT(BITS(src2,31,0) == 0 ? 0 : BITS(src1,31,0) / BITS(src2,31,0),32));
  ...
  INSTPAT("0000001 ????? ????? 110 ????? 01110 11", remw   , R, R(dest) = SEXT(BITS(src2,31,0) == 0 ? 0 : BITS(src1,31,0) % BITS(src2,31,0),32));
