...
class VTop___024root final : public VerilatedModule {
  public:
    ...
    struct {
        ...
        CData/*7:0*/ Top__DOT__decoder__DOT___crtlsignals_T_134;
        CData/*7:0*/ Top__DOT__decoder__DOT___crtlsignals_T_149;
        CData/*7:0*/ Top__DOT__decoder__DOT___crtlsignals_T_164;
        CData/*0:0*/ Top__DOT__decoder__DOT___crtlsignals_T_222;
        CData/*2:0*/ Top__DOT__decoder__DOT___crtlsignals_T_253;
        CData/*2:0*/ Top__DOT__decoder__DOT___crtlsignals_T_268;
        CData/*2:0*/ Top__DOT__decoder__DOT___crtlsignals_T_283;
        CData/*2:0*/ Top__DOT__decoder__DOT__ImmType;
        CData/*0:0*/ Top__DOT__decoder__DOT___crtlsignals_T_315;
        CData/*0:0*/ Top__DOT__decoder__DOT___crtlsignals_T_332;
        CData/*0:0*/ Top__DOT__decoder__DOT___crtlsignals_T_349;
        CData/*0:0*/ Top__DOT__decoder__DOT___crtlsignals_T_383;
        CData/*0:0*/ Top__DOT__decoder__DOT___crtlsignals_T_400;
        CData/*0:0*/ Top__DOT__decoder__DOT___crtlsignals_T_457;
        ...
        IData/*31:0*/ Top__DOT__alu__DOT___result_T_156;
        IData/*31:0*/ Top__DOT__alu__DOT___result_T_173;
        VlWide<4>/*127:0*/ Top__DOT__alu__DOT___result_T_219;
        VlWide<4>/*127:0*/ Top__DOT__alu__DOT___result_T_243;
        VlWide<4>/*127:0*/ Top__DOT__alu__DOT___result_T_265;
        VlWide<4>/*127:0*/ Top__DOT__alu__DOT___result_T_289;
        ...
        QData/*62:0*/ Top__DOT__alu__DOT___result_T_147;
    };
    struct {
        QData/*63:0*/ Top__DOT__alu__DOT___result_T_187;
