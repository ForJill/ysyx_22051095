...
#endif
                VL_FATAL_MT("vsrc/Top.v", 6638, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/Top.v", 6638, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/Top.v", 6638, "", "NBA region did not converge.");
            }
